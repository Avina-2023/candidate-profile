...
export class SkillexService {
  ...
  forgotPassword(email) {
    ...
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/userforgotPassword`,
      email
    );
  }
  // Reset Password
  passwordReset(data) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/submitResetPassword`,
      data
    );
  }
  // userlogin
  login(loginData) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/userLogin`,
      loginData
    );
  }
  ...
  saveCandidateProfile(loginData) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/addUserDetail`,
      loginData
    );
  }
  ...
  uploadfile(profileform) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/imageUploadForProfile`,
      profileform
    );
  }
  pdfFileUpload(profileform) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/imageUpload`,
      profileform
    );
  }
  //progressbar
  candidateDetails(data) {
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/getcandidatedetail`,
      data
    );
  }
  ...
  getCustomHeaders(): HttpHeaders {
    const headers = new HttpHeaders({
      ...
      .set(
        'Authorization',
        'Bearer '
      );
  ...
  districtList(stateId) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/districtList`,
      stateId
    );
  }
  collegeList() {
  ...
  getdescription(data: any) {
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/getprofileSummary`,
      data
    );
  }
  ...
  geteduTechCourses() {
    ...
    return this.http.get(`${LMSBASE_URL}/getCourses`, { headers: headers });
  }

  //get JOB Description page
  getJobDetail(jobdata) {
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/getJobDetail`,
      jobdata
    );
    // {"jobId":"34567"}
  }
  ...
  submitJobForm(jobdata) {
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/submitJobForm`,
      jobdata
    );
    // {"jobId":"34567"}
  }
  ...
  externalLogin(loginData) {
    // this.datas is api body data
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/externallogin`,
      loginData
    );
  }
  ...
  getassesment(assessdata) {
    return this.http.post(
      `${environment.SKILLEX_BASE_URL}/getTasktype`,
      assessdata
    );
  }
